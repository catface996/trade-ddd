package com.catface.trade.repository.generator;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    public void generateAllCode() {
        generateByTables(serviceNameStartWithI, packageName, "pay_order");
    }

    @Test
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "pay_order");
    }
