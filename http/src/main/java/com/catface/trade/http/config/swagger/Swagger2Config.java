package com.catface.trade.http.config.swagger;
...
public class Swagger2Config {
	...
	public Docket createRestWebApi() {
		return new Docket(DocumentationType.SWAGGER_2)
						...
						.select()
						// 扫描的包所在位置
						.apis(RequestHandlerSelectors.basePackage("com.catface.trade.http.web"))
						// 扫描的 URL 规则
	...
	public Docket createRestRpcApi() {
		return new Docket(DocumentationType.SWAGGER_2)
						...
						.select()
						// 扫描的包所在位置
						.apis(RequestHandlerSelectors.basePackage("com.catface.trade.http.rpc"))
						// 扫描的 URL 规则
						.paths(PathSelectors.any())
						.build();
	}
